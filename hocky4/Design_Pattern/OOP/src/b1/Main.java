		...
		while (true) {
			...
			case "1": {
				...
				case "b": {
					...
					managerOfficer.themCanBo(congNhan);
				...
				case "c": {
					...
					managerOfficer.themCanBo(nhanVien);
			...
			case "2": {
				...
				String name = scanner.nextLine();
				System.out.println(managerOfficer.timKiem(name));
				break;
			}
			case "3": {
				System.out.println(managerOfficer.printList());
				break;
			}
			case "4": {
				return;
